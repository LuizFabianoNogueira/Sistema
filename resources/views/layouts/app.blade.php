...
<head>
    ...
    <title>GN-DASHBOARD | Empty Page</title>
        ...
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top  " role="navigation" style="margin-bottom: 0">
                ...
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <a href=" {{ route('locale', ['pt']) }}">PT</a> -
                    <a href=" {{ route('locale', ['en']) }}">EN</a> -
                    <a href=" {{ route('locale', ['es']) }}">ES</a>

                    <li>
                        <span class="m-r-sm text-muted welcome-message">Welcome to GN-DASHBOARD+ Admin Theme.</span>
                    </li>
                    <li class="dropdown">
